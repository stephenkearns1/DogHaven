...
import com.haven.dog.doghaven.Helpers.BreedInfo_PopUp;
...
public class BreedInfoActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // info= (ScrollView) findViewById(R.id.scroll);
        ...
        medical = (Button) findViewById(R.id.physicalBT) ;
        social = (Button) findViewById(R.id.physicalBT) ;
        exercise = (Button) findViewById(R.id.physicalBT) ;
    ...
    public void onClick(View v) {
            startActivity(new Intent(BreedInfoActivity.this, BreedInfo_PopUp.class));
    }
}
